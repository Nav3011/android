package com.example.gondunaveen.tic;
...
public class BluetoothConnectionService {
     ...
     * like a server-side client .It runs untill a connection is accepted or
     * until cancelled
     */
        ...
        public void run() {
            ...
            while(true) {
                try {
                    ...
                    incomingMessageIntent.putExtra("id", incomingMessage);
                    LocalBroadcastManager.getInstance(mContext).sendBroadcast(incomingMessageIntent);

                    //if(incomingMessage=="0") {
                        //board[0] = active;
                        //Button b1 = (Button)((MainActivity)mContext).findViewById(R.id.block1);
                        //b1.setText(active);
                    //}
                    //if(incomingMessage=="1") {
                    //    board[1] = active;
                    //    Button b2 = (Button)((Activity)mContext).findViewById(R.id.block2);
                    //    b2.setText(active);
                   // }
                    //active = active == "X" ? "O" : "X";
                }catch(IOException e) {
